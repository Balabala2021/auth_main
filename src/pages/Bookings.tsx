      ...
      try {
        ...
        bookingsData = bookingsSnapshot.docs.map((doc) => {
          ...
          return {
            ...
            invoice_created_date: data.invoice_created_date?.toDate
              ? data.invoice_created_date.toDate()
              : null,
  ...
  const columns: GridColDef[] = [
    ...
    },
    {
      ...
      valueGetter: (params) => {
        ...
        return room
          ? `${room.room_number}${type ? " - " + type.title : ""}`
          : "-";
      },
    },
    {
...

    {
      ...
      valueGetter: (params: { row: Booking }) => {
        return params.row.payment_received_date
          ? new Date(params.row.payment_received_date).toLocaleDateString()
          : "-";
      },
    },
    {
